...
public:
	...
	void subscribeService(bool smart_locks, bool smart_lighting, bool smart_speakers, bool smart_curtains, bool smart_heating, bool smart_cctv)
	{
...
public:
	...
	bool newUser()
    {
		...
		if (myFile.is_open())
		{
			...
			users.insert(new User(cnic, pN, fN, lN, hasCar));
		...
		if (myFile.is_open())
		{
			...
			users[cnic]->subscribeService(checkLocks, checkLights, checkSpeakers, checkCurtains, checkHeating, checkCameras);
		}
