...
//     T *_deleteNode(T *node, KEY key)
//     {
//         if (node == NULL)
//         {
//             cout << "T with Key = " << key << " not found!" << endl;
//             return NULL;
//         }
...
//                 if (node->lChild->height > node->rChild->height)
//                 {
//                     T *successor = _findMax(node->lChild);
...
//                 else
//                 {
//                     T *successor = _findMin(node->rChild);
...
//         //! T has balance factor of -1, 0, +1,
//         //* which we do not need to balance.
//         return node;
//     }

//     T *_leftLeftCase(T *node)
//     {
//         return _rightRotate(node);
//     }

//     T *_rightRightCase(T *node)
//     {
//         return _leftRotate(node);
//     }

//     T *_leftRighCase(T *node)
//     {
//         node->lChild = _leftRotate(node->lChild);
//         return _rightRotate(node);
//     }

//     T *_rightLeftCase(T *node)
//     {
//         node->rChild = _rightRotate(node->rChild);
//         return _leftRotate(node);
//     }

//     T *_rightRotate(T *node)
//     {
//         T *left = node->lChild;
