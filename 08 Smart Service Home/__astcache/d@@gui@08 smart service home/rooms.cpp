...
//	ShowMessage("HI");
//
//	bool lights, thermostat, security, cameras, assistant, speakers;

//	Home *home = mainForm->getHomeObj();
//	mainForm->setBools(cnic, lights, thermostat, security, cameras, assistant, speakers);
//  mainForm->setBools(cnic);
